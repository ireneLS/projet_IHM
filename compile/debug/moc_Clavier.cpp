...
const QMetaObject Clavier::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Clavier.data,
      qt_meta_data_Clavier,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Clavier::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Clavier.stringdata0))
        return static_cast<void*>(const_cast< Clavier*>(this));
